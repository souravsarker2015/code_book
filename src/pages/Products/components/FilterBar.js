...
export const FilterBar = ({setShow}) => {
    const {state, dispatch} = UseFilter();//eslint-disable-line
                ...
                <div className="py-4 overflow-y-auto">
                    <ul className="text-slate-700 dark:text-slate-100">
                        ...
                        <li className="mt-1 mb-5">
                            ...
                            <div className="flex items-center my-1">
                                <input onChange={() => dispatch({type: "RATINGS", payload: {ratings: "1STARSABOVE"}})} id="rating-sort-4" type="radio" value="" name="rating-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600"/>
